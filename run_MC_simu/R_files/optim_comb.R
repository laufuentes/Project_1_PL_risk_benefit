...
df_complete <- read.csv(file.path(folder,"results","data","oracular",paste0("df_complete_",i,".csv")),stringsAsFactors = FALSE)
...
saveRDS(theta, file = file.path(folder,"results","oracular","theta_opt",paste0("theta_", i,"_",j, ".rds")))
saveRDS(res, file = file.path(folder,"results","oracular","individual_results",paste0("res_", i,"_",j, ".rds")))
